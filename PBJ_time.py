...
if bread > 1 and peanut_butter > 0 and jelly > 0:
	if peanut_butter>= bread/2 and jelly >= bread/2:
		print "I can make {0} complete PBJ sandwiches." .format(bread/2)
	elif peanut_butter >= jelly:
		print "I can make {0} complete PBJ sandwiches." .format(jelly)
	else:
		print "I can make {0} complete PBJ sandwiches." .format(peanut_butter)
	if bread % 2 == 1 and peanut_butter > bread/2 and jelly > bread/2: 
		print "I can also make one open-faced sandwich."

else:
	if bread == 0 and peanut_butter == 0 and jelly == 0:
		print "Looks like I can't make any sandwiches today. I need to buy bread, peanut butter, and jelly."
	elif bread == 0 and peanut_butter == 0 and jelly > 0:
		print "Looks like I can't make any sandwiches today. I need to buy bread and peanut butter."
	elif bread == 0 and peanut_butter > 0 and jelly == 0:
		print "Looks like I can't make any sandwiches today. I need to buy bread and jelly."
	elif bread == 0 and peanut_butter > 0 and jelly > 0:
		print "Looks like I can't make any sandwiches today. I need to buy bread."
	elif bread > 0 and peanut_butter >0 and jelly == 0:
		print "Looks like I can't make any sandwiches today. I need to buy jelly."
	elif bread > 0 and peanut_butter == 0 and jelly > 0:
		print "Looks like I can't make any sandwiches today. I need to buy peanut butter."
	else:
		print "Looks like I can't make any sandwiches today. I need to buy peanut butter and jelly."
